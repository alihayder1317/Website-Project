...
function btnClicked() {
  ...
  if (answer1 == "julian palacios") {
    ...
    document.getElementById(
      "out1"
    ).innerHTML = `Incorrect! The correct answer is Julian Palacios`;
    result1 = 0;
  }

  if (answer2 == "fc barcelona") {
    ...
    document.getElementById(
      "out2"
    ).innerHTML = `Incorrect! The correct answer is FC Barcelona`;
    result2 = 0;
  }

  if (answer3 == "santiago bernabeu") {
    ...
    document.getElementById(
      "out3"
    ).innerHTML = `Incorrect! The correct answer is Santiago`;
    result3 = 0;
  }

  if (answer4 == "cristiano ronaldo") {
    ...
    document.getElementById(
      "out4"
    ).innerHTML = `Incorrect! The correct answer is Cristiano Ronaldo`;
    result4 = 0;
  }
